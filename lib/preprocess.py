...
def preprocess(dataset, img_size, scale=False, norm=False, pad=False, remove=False):
    if dataset == 'aptos2019':
        df = pd.read_csv('C:/Users/USER/Desktop/crystal/cv/final/train.csv')
        img_paths = 'C:/Users/USER/Desktop/crystal/cv/final/train_images/' + df['id_code'].values+'.png'
        
    elif dataset == 'aptos2015':
        df = pd.read_csv('C:/Users/USER/Desktop/crystal/cv/final/trainLabels2.csv')
        img_paths = 'C:/Users/USER/Desktop/crystal/cv/final/train_images1/' + df['image'].values+'.jpeg' 
        
    elif dataset == 'test':
        df = pd.read_csv('C:/Users/USER/Desktop/crystal/cv/final/test.csv')
